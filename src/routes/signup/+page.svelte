				...
				<div>
					...
					<div class="mt-2">
						<input
							...
							autocomplete="email"
							required
							class="block w-full rounded-md border-0 py-1.5 sm:bg-zinc-900 bg-zinc-800 text-white shadow-sm ring-1 ring-inset ring-zinc-600 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-pink-500 sm:text-sm sm:leading-6"
						/>
					</div>
				</div>
				...
				<div>
					...
					<div class="mt-2">
						<input
							...
							required
							class="block w-full sm:bg-zinc-900 bg-zinc-800 text-white rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-zinc-600 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-pink-500 sm:text-sm sm:leading-6"
						/>
					</div>
				</div>
